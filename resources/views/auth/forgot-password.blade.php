    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-100 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="max-w-md w-full space-y-8 z-10">
            ...
            <div class="text-center">
                ...
                <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight animate-fade-in-up delay-100">Atur Ulang Kata Sandi</h2>
                <p class="mt-2 text-sm text-gray-500 font-medium animate-fade-in-up delay-200">Kami akan mengirimkan tautan keamanan</p>
            </div>
